...
from app.api.v1.endpoints import home, user, field_form, crop_health, ndvi, auth, weather, analyze, health_score
...
api_v1_router.include_router(
    field_form.router, prefix="/field-form", tags=["field-form"])
api_v1_router.include_router(
    crop_health.router, prefix="/crop-health", tags=["crop-health"])
api_v1_router.include_router(ndvi.router, prefix="/fields", tags=["ndvi"])
api_v1_router.include_router(
    weather.router, prefix="/weather", tags=["weather"])

api_v1_router.include_router(
    analyze.router, prefix="/crop", tags=["Crop Analysis"])
api_v1_router.include_router(
    health_score.router, prefix="/fields", tags=["ndvi"])
